            ...
            <div className="bg-[#E8FFF0] mb-10">
                <div className="py-20 flex flex-col items-center justify-center px-20">
                    ...
                    <p className="text-xl text-center">
                        Ready to take the next step in your career? Submit your resume and a cover letter to <a href="mailto:careers@medymatic.com" className="underline">careers@medymatic</a> or fill out the <a href="/careerform" className="underline">application form here.</a> We look forward to hearing from you and learning how you can contribute to our continued success!
                    </p>
                </div>
