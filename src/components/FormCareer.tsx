...
export const FormCareer = () => {
    return (
        <section className="py-20 px-4 md:px-28 grid grid-cols-1 lg:grid-cols-2 md:gap-10">
            ...
            <div className="pb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-[#004E43] mb-6">Join Our Team and Take the Next Step in Your Career!</h2>
                <p className="text-xl mb-6">Start Your Journey with MedyMatic—Where Your Skills Make a Difference.</p>
                <ul>
            ...
            <div className="">
                <form className="w-full flex flex-col gap-5">
                    <label htmlFor="first-name" className="text-xl font-medium">Applicant's full name*</label>
                    <input
                        required
                    ...
                    />
                    <label htmlFor="residence" className="text-xl font-medium">City of Residence*</label>
                    <input
                    ...
                    />
                    <label htmlFor="experience" className="text-xl font-medium">Total Experience in US Healthcare*</label>
                    <input
                        required
                        placeholder="Enter your total years of experience in US healthcare"
                        className="text-sm text-black border border-black rounded-sm p-2"
                        name="experience"
                        aria-label="experience"
                    />
                    <label htmlFor="message" className="text-xl font-medium">Note to MedyMatic</label>
                    <textarea
                    ...
                    <div className="flex flex-row items-center justify-center gap-3">
                        ...
                        <div className="hidden md:flex gap-2">
                            <a
                                ...
                                target="_blank"
                                className={`border ${buttonVariants({ variant: "secondary", size: "lg" })}`}
                            >
                                Submit
                            </a>
                        </div>
