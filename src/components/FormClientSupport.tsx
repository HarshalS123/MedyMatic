        ...
        <section className="py-20 px-10 md:px-48 md:gap-10">
            <div className="">
                <form className="w-full flex flex-col gap-5">
                    ...
                    />
                    <label htmlFor="clientid" className="text-xl font-medium">Client ID</label>
                    <input
                    ...
                    />
                    <label htmlFor="issuetype" className="text-xl font-medium">Issue Type</label>
                    <input
                        required
                        ...
                        aria-label="experience"
                    />
                    <label htmlFor="message" className="text-xl font-medium">Brief Description</label>
                    <textarea
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-3">
                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center h-12 px-2 w-full border border-[#A5A5A5] cursor-pointer bg-gray-50">
